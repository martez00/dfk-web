...
@section('content')
    <a class="btn btn-outline-dark btn-sm mb-3" href="{{ route('tournaments.index') }}">← Turnyrai</a>
    @if(isset($tournament))
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="level" name="level" min="1" max="5"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="cup_tournament" name="cup_tournament" value="1" @if (isset($tournament) && $tournament->cup_tournament) checked @endif>
